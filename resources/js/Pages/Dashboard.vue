...
const brandData = ref([
  {
    logo: 'https://via.placeholder.com/50', // Placeholder URL
    name: 'Google',
    visitors: 3.5,
    revenues: '5,768',
    sales: 590,
    ...
    <AppLayout title="Dashboard">
        ...
        <div class="flex flex-col">
            ...
            <div
                ...
                :key="key"
                :class="`grid grid-cols-3 sm:grid-cols-5 ${key === brandData.length - 1 ? '' : 'border-b border-stroke dark:border-strokedark'}`"
            >
