...
<template>
    <Head title="Welcome" />
    <div class="bg-blue-300 text-black/50 dark:text-white/50">
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="pt-3 sm:pt-5">
                        <h1 class="text-xl font-semibold text-black dark:text-white align-middle text-center" style="padding: 10px; margin: 5px;"> DIABETRACK</h1>
                    </div>
